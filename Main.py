...
from Exercise1 import BlendingInterface 
import subprocess
...
class MainWindow(QMainWindow):
    ...
    def select_exercise(self, exercise_button):
        ...
        if case == "PL : Blending Problem":
            self.exercice1 = BlendingInterface()
            self.exercice1.show()
        elif case == "PLNE : Shortest Path":
            from Exercise2 import Exercise3
